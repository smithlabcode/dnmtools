...
double RegressionNano::tolerance = 1e-4;
double RegressionNano::stepsize = 0.01;
std::uint32_t RegressionNano::max_iter = 250;

void
RegressionNano::parse(const std::string &line) {
