...
# including in the subdirectories of dnmtools src (for the git
# submodules).
#
...
runautoreconf() {
    autoreconf -i src/abismal/src/smithlab_cpp;
    autoreconf -i src/abismal;
...
then
    ...
    echo "  not obtained by cloning the dnmtools git repo.              "
    echo "                                                              "
