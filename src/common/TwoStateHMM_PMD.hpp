...
class TwoStateHMM {
public:
  TwoStateHMM(const double mp, const double tol, const size_t max_itr,
              const bool v, bool d = false) :
    MIN_PROB(mp), tolerance(tol), max_iterations(max_itr), VERBOSE(v),
    DEBUG(d) {}
  ...
  PosteriorDecoding_rep(
    ...
    const std::vector<double> &end_trans, const std::vector<double> &fg_alpha,
  ...
  PosteriorScores_rep(
    ...
    const std::vector<double> &end_trans, const std::vector<double> &fg_alpha,
    const std::vector<double> &fg_beta, const std::vector<double> &bg_alpha,
    const std::vector<double> &bg_beta, const std::vector<bool> &classes,
    std::vector<double> &llr_scores,
    const std::vector<bool> &array_status) const;
  ...
  TransitionPosteriors_rep(
    ...
    const std::vector<double> &end_trans, const std::vector<double> &fg_alpha,
    const std::vector<double> &fg_beta, const std::vector<double> &bg_alpha,
    const std::vector<double> &bg_beta, const std::vector<bool> &array_status,
    const size_t transition, std::vector<double> &scores) const;
...
private:
  ...
  estimate_transitions(
    const std::vector<std::pair<double, double>> &vals, const size_t start,
    const size_t end, const std::vector<std::pair<double, double>> &f,
    const std::vector<std::pair<double, double>> &b, const double total,
    const EmissionDistribution &fg_distro,
    const EmissionDistribution &bg_distro, const double lp_ff,
  ...
  estimate_transitions_rep(
    ...
    const std::vector<std::unique_ptr<EmissionDistribution>> &fg_distro,
    const std::vector<std::unique_ptr<EmissionDistribution>> &bg_distro,
    const double lp_ff, const double lp_fb, const double lp_bf,
    const double lp_bb, std::vector<double> &ff_vals,
    std::vector<double> &fb_vals, std::vector<double> &bf_vals,
    std::vector<double> &bb_vals) const;
  ...
  single_iteration_rep(
    ...
    std::vector<std::pair<double, double>> &backward, double &p_sf,
    double &p_sb, double &p_ff, double &p_fb, double &p_ft, double &p_bf,
  ...
  BaumWelchTraining_rep(
    ...
    double &p_bt, std::vector<std::unique_ptr<EmissionDistribution>> &fg_distro,
  ...
  PosteriorScores_rep(
    ...
    const std::vector<std::unique_ptr<EmissionDistribution>> &fg_distro,
    const std::vector<std::unique_ptr<EmissionDistribution>> &bg_distro,
    const std::vector<bool> &classes, std::vector<double> &llr_scores) const;
